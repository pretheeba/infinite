...
namespace TrainReservationSystem
{
    class Program
    {
        private static string _connectionString = "data source=ICS-LT-98M46D3;initial catalog=Miniproject;user id=sa;password=pretheeba;"; // Replace with your connection string
